...
public class MenuPanel extends JPanel{
	...
	public void paint(Graphics g) {
		try {
			...
			//添加联机模式按钮
			if(Common.getCommon().getCurrent_button().equals("play_online")) {
			...
			//添加双人对弈按钮
			if(Common.getCommon().getCurrent_button().equals(Common.TWO_PLAYER_BUTTON)) {
			...
			//添加关于按钮
			if(Common.getCommon().getCurrent_button().equals("about")) {
			...
			//添加规则按钮
			if(Common.getCommon().getCurrent_button().equals("rules")) {
